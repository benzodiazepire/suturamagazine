document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        it: {
            ...
            archive_sub: "( blog )",
            archive_item1_date: "[ 05.02.2026 ] — SAGGIO VISIVO",
            archive_item1_title: "il peso del vuoto",
            archive_item1_desc: "Un'indagine sulla persistenza degli oggetti dimenticati negli spazi urbani.",
            archive_item2_date: "[ 28.01.2026 ] — INTERVISTA",
            archive_item2_title: "estetica della polvere",
            archive_item2_desc: "Dialogo con l'artista X su ciò che resta quando il movimento si ferma.",
        ...
        en: {
            ...
            archive_sub: "( blog )",
            archive_item1_date: "[ 05.02.2026 ] — VISUAL ESSAY",
            archive_item1_title: "the weight of the void",
            archive_item1_desc: "An investigation into the persistence of forgotten objects in urban spaces.",
            archive_item2_date: "[ 28.01.2026 ] — INTERVIEW",
            archive_item2_title: "aesthetics of dust",
            archive_item2_desc: "Dialogue with artist X on what remains when movement stops.",
